...
class AboutSymbols < Neo::Koan
  ...
  #
  # my answer: becouse the symbol with method's name (:test_method_names_become_symbols)
  # isn't defined yet
  ...
  # my reaction: It's interesting! Will know.
  ...
  #
  # my answer: maybe some of these symbols can be matched with already existed symbols?
end
