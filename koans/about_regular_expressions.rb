...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why? Becouse the operator return first matching in the string
  # regardless length of next matching
  ...
  # my answer: the difference is that a character class gives one or more uniq symbols
  # in any combination
  # but alternation gives only one option from available  alternatives
